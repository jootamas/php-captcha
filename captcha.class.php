...
class Captcha {
  ...
  * @var int
  */
 public $vertical_push = 12;
 /**
  */
 public function __construct(){
  if(!is_file($this->ttf)){
   echo 'Captcha ERROR: TTF not found!';
   exit;
  }
 }
 /**
